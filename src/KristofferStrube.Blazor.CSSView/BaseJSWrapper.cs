...
/// <summary>
/// A base class for all base wrappers introduced in Blazor.CSSView.
/// </summary>
public abstract class BaseJSWrapper : IJSWrapper
{
    /// <summary>
    /// A lazily loaded task that evaluates to a helper module instance from the Blazor.CSSView library.
    /// </summary>
